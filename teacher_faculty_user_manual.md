...
- **Where does it update?**:
  - Once approved, the student is **automatically marked as "Approved Leave" or "On Duty"** in your morning roll-call register.
...
#### Tool C: 3:45 PM "Safe Boarding" Dismissal View
- **What it is**: At 3:45 PM when the final bell rings, chaotic dismissal begins. This view shows how every child is traveling home.
- **How to use it**:
  - Click the **"Safe Boarding View"** toggle at the top of the roster.
  - Filter by:
    - 🚌 **Bus Riders**: Shows their assigned bus route (e.g., *Route #04 - Fathekhan Pet to Haranathpuram*) and driver name.
    - 🚗 **Private Pickup**: Shows authorized guardian names and whether an early gate pass was issued.
...
### 3. 📈 Academics, Marks & Predictive AI Radar (`/portal/faculty/academics`)

#### What is the purpose of this page?
To eliminate manual grade calculations and help teachers immediately spot which students are falling behind before term exams, with automated AI remedial interventions.

#### What are the 4 main tools on this screen?

#### Tool A: Digital Gradebook Roster
- View all students in your class with their scores across Formative Assessments (FA-1, FA-2) and Summative Assessments (SA-1).
- Automatically calculates the **Class Average** (e.g., 78.4%) and highest mark.

#### Tool B: Bulk OMR CSV Score Uploader
- **The Problem**: Entering marks one by one for 45 students takes over an hour.
- **The Finkfold Solution**:
  1. Click **"Bulk OMR CSV Upload"** (Purple button).
  2. Drag and drop your OMR scanner CSV file or spreadsheet containing columns: `AdmissionNo, Subject, Score, MaxMarks`.
  3. Click **"Process & Ingest Scores"**.
  4. The system validates all admission numbers in 2 milliseconds, updates every student's permanent academic record, and recalculates class percentiles automatically.

#### Tool C: Predictive AI Remedial Radar
- **What it is**: The system continuously monitors student exam performance. Any student scoring below 50% or in the **bottom 15% of the class** is automatically highlighted in red.
- **Pinpoint Weak Subtopics**: The AI breaks down the test and specifies the exact concept the child struggled with (e.g., *"Struggles with 3D Geometry Frustum Volume Formulae"*).
- **1-Click Remedial Worksheet Dispatch**:
  - Click the **"Dispatch AI Remedial Worksheet"** button next to the student's name.
  - The AI instantly generates a customized 15-question targeted practice worksheet with hints and delivers it straight to the student's **Exams & AI Skill Gaps** portal tab for weekend practice.
  - A notification is sent to the parents: *"Teacher has assigned a personalized practice worksheet to help Rahul master 3D Geometry."*

#### Tool D: Syllabus & Lesson Progress Tracker
- **What it is**: Track your Term 1 and Term 2 syllabus completion aligned with the official CBSE/State Board curriculum.
- **How to use it**:
  - View chapters and subtopics (e.g., *Unit 1: Real Numbers & Euclid's Lemma*, *Unit 2: Polynomials*).
  - Click the checkmark next to each subtopic as you complete teaching it in class.
  - The progress bar updates dynamically (e.g., *"68% Completed - On Track for October Exams"*).

---

### 4. 🛡️ Conduct Ledger & Merit Economy (`/portal/faculty/conduct`)

#### What is the purpose of this page?
To encourage positive behavior and maintain discipline transparently without yelling, paper detention slips, or biased diary notes.

#### What can you do here?

#### 1-Click Merit Awards (Positive Reinforcement)
- Recognize students who do good deeds in school.
- Click **"Award Merits"** and select preset buttons:
  - 🌟 **+5 Merits**: Helping a peer understand a difficult concept.
  - 🤝 **+10 Merits**: Outstanding teamwork or classroom cleanliness.
  - 🏆 **+15 Merits**: Winning an inter-school competition or science exhibition.
- **Where does it update?**: Added to the student's **Merit Bank** on their portal, boosting their House Points leaderboard and unlocking school privileges.

#### Demerit Logging & The Parent E-Signature Lock
- Address disciplinary issues constructively and with full accountability.
- Click **"Log Demerit"** and pick preset categories:
  - ⚠️ **-5 Demerits**: Incomplete uniform or repeated late arrival.
  - 🚫 **-10 Demerits**: Disrupting classroom instruction or incomplete homework.
- **The Mandatory Parent E-Signature Lock Trigger**:
  - When issuing a serious demerit, check the box: **"Require Guardian Digital E-Signature"**.
  - **What happens?**: 
    1. The student's portal self-service features (such as club signups or canteen pre-ordering) are **frozen**.
    2. A formal digital disciplinary notice is sent to the parent's phone.
    3. The parent must log in with their OTP, review the teacher's incident report, and provide their **electronic sign-off**.
    4. Only after the parent signs does the student portal unlock, ensuring parents are actively involved in discipline.
...
### 5. 💬 Office Hours & PTM Itinerary (`/portal/faculty/messages`)
...
# 🔄 Quick Reference: "If I Do X, Where Does It Update?"
...
### Q1: What if a student arrives late after I already submitted morning attendance?
