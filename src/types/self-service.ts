...
export const INITIAL_EXAM_RECORDS: MultiTierExamRecord[] = [
  ...
  {
    id: "exam-weekly-4",
    examName: "Weekly Chapter Test 4: Quadratic Equations & Polynomials",
    examType: "weekly",
    term: "Term 1 (2026-27)",
    date: "19 Sep 2026",
    ...
    totalStudents: 42,
    subjects: [
      { subject: "Mathematics", code: "MAT-10", maxMarks: 25, marksObtained: 24, classAverage: 18, grade: "A1", percentile: 96 },
      { subject: "Physical Science", code: "SCI-10P", maxMarks: 25, marksObtained: 22, classAverage: 17, grade: "A1", percentile: 91 },
      { subject: "English Language & Lit", code: "ENG-10", maxMarks: 25, marksObtained: 23, classAverage: 19, grade: "A1", percentile: 93 },
    ],
  },
  {
    id: "exam-weekly-3",
    examName: "Weekly Chapter Test 3: Chemical Reactions & Acids",
    examType: "weekly",
    term: "Term 1 (2026-27)",
    date: "12 Sep 2026",
    ...
    totalStudents: 42,
    subjects: [
      { subject: "Physical Science", code: "SCI-10P", maxMarks: 25, marksObtained: 23, classAverage: 17, grade: "A1", percentile: 94 },
      { subject: "Biological Science", code: "SCI-10B", maxMarks: 25, marksObtained: 21, classAverage: 16, grade: "A2", percentile: 86 },
      { subject: "Mathematics", code: "MAT-10", maxMarks: 25, marksObtained: 22, classAverage: 18, grade: "A1", percentile: 89 },
    ],
  },
  {
    id: "exam-weekly-2",
    examName: "Weekly Chapter Test 2: Light Reflection & Human Eye",
    examType: "weekly",
    term: "Term 1 (2026-27)",
    date: "05 Sep 2026",
    ...
    totalStudents: 42,
    subjects: [
      { subject: "Physical Science", code: "SCI-10P", maxMarks: 25, marksObtained: 21, classAverage: 16, grade: "A2", percentile: 85 },
      { subject: "Social Studies", code: "SOC-10", maxMarks: 25, marksObtained: 22, classAverage: 17, grade: "A1", percentile: 90 },
      { subject: "Second Language (Telugu)", code: "TEL-10", maxMarks: 25, marksObtained: 21, classAverage: 17, grade: "A2", percentile: 86 },
    ],
  },
  {
    id: "exam-weekly-1",
    examName: "Weekly Chapter Test 1: Real Numbers & Cell Biology",
    examType: "weekly",
    term: "Term 1 (2026-27)",
    date: "29 Aug 2026",
    ...
    totalStudents: 42,
    subjects: [
      { subject: "Mathematics", code: "MAT-10", maxMarks: 25, marksObtained: 23, classAverage: 17, grade: "A1", percentile: 92 },
      { subject: "Biological Science", code: "SCI-10B", maxMarks: 25, marksObtained: 23, classAverage: 18, grade: "A1", percentile: 93 },
      { subject: "English Language & Lit", code: "ENG-10", maxMarks: 25, marksObtained: 22, classAverage: 18, grade: "A1", percentile: 89 },
    ],
  },
];
