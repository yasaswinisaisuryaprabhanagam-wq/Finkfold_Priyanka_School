...
export async function placeStoreOrderAction(payload: {
  ...
  const newOrder: StoreOrder = {
    ...
    status: "packing",
    pickupPassQr: `QR-STORE-${orderNum}-LUNCH`,
    pickupSlot: "Tomorrow Lunch Break (12:45 PM – 01:25 PM) • School Store",
    createdAt: "Today",
  };
  ...
  return {
    success: true,
    order: newOrder,
    message: `Order #${orderNum} placed successfully! Packing slip sent to storekeeper. Show pickup QR code during lunch break.`,
  };
}
